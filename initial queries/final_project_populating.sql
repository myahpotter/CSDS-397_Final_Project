...
(
	...
	peak AS 
(
	SELECT "Song", MIN("Peak Position") as highest_peak
	FROM source."streams_source" 
	GROUP BY "Song"
)
...
peak.highest_peak, maximum_time.max_weeks,  song_debuts.DebutDate
...
LEFT JOIN peak ON peak."Song" = song_debuts."Song";
